...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateHashHistory = __webpack_require__(9);
	
	var _historyLibCreateHashHistory2 = _interopRequireDefault(_historyLibCreateHashHistory);
	
	var _phRouterTransition = __webpack_require__(53);
	
	var _phRouterTransition2 = _interopRequireDefault(_phRouterTransition);
	
	var _detailJs = __webpack_require__(60);
	
	var _detailJs2 = _interopRequireDefault(_detailJs);
	
	var _aboutJs = __webpack_require__(61);
	
	var _aboutJs2 = _interopRequireDefault(_aboutJs);
	...
	var Index = (function (_Component) {
	    ...
	    Index.prototype.render = function render() {
	        return _react2['default'].createElement(
	            'div',
	            { className: 'index-wrapper ph-transition-index' },
	...
	var PageTransition = (function (_Component2) {
	    _inherits(PageTransition, _Component2);
	    ...
	    PageTransition.prototype.loadedCallback = function loadedCallback() {
	        // 切换结束的回调函数
	    };
	
	    PageTransition.prototype.render = function render() {
	        return _react2['default'].createElement(
	            _phRouterTransition2['default'],
	            _extends({}, this.props, { transitionName: 'slide-left', loadedCallback: this.loadedCallback.bind(this) }),
	            this.props.children
	        );
	    };
	...
	var AppRouter = (function (_Component3) {
	    ...
	    AppRouter.prototype.render = function render() {
	        return _react2['default'].createElement(
	            _reactRouter.Router,
	            ...
	            _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(_reactRouter.Route, { path: '/detail', name: 'detail', component: _detailJs2['default'] }),
	                _react2['default'].createElement(_reactRouter.Route, { path: '/about', name: 'about', component: _aboutJs2['default'] }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Router2 = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Detail = (function (_Component) {
	    ...
	    Detail.prototype.shouldComponentUpdate = function shouldComponentUpdate() {
	        return false;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var About = (function (_Component) {
	    ...
	    About.prototype.shouldComponentUpdate = function shouldComponentUpdate() {
	        return false;
	    };
